...
<body>
    ...
    <fieldset>
    <legend><h2><center><strong>Certificate of Vaccination (Dose 2)</strong></center></h2></legend>
    <div class="row">
        
            It is to hereby certify that <b><em><?php echo $_SESSION["name_user"]; ?></em></b> has been vaccinated against COVID-19 (Dose 2).
    ...
    <div class="row">
        <div class="left">
            <table>
                ...
                <tr><td>Date of Vaccination dose 2 </td><td>:</td><td> <?php echo $row['vac2_date'] ; ?></td></tr>
            </table>
        </div>
        <div class="right">
    ...
    <div class="row">
        ...
        <div class="right" style="margin-bottom:0; margin-right:2%;">
            ...
            Verified on : <?php echo $row['vac2_date'] ; ?>
            </p>
        </div>
    </div>
    </fieldset>
